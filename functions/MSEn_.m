function [MSx, CI] = MSEn_(Sig, Mobj, name,varargin) 
...
if p.Results.Plotx
   ...
   plot(1:p.Results.Scales,MSx,'color',[8 63 77]/255,'LineWidth',1)   
   scatter(1:p.Results.Scales,MSx,20,[1 0 1],'filled')   
   xlabel('Scale','FontSize',12,'FontWeight','bold','Color',[7 54 66]/255)
   ylabel('ApEn','FontSize',12,'FontWeight','bold','Color',[7 54 66]/255)
%    title(sprintf(name+' Multiscale %s (%s- method)',func2str(Y{1}),...
